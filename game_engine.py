...
def play_isoKnight(player_1, player_2, init_state):
...
def play_with_minimax():
    player_1 = player_agent(minimax_isoKnight.maximin)
    player_2 = player_agent(minimax_isoKnight.minimax)
...
def play_with_heuristics():
    ...
    player_1 = player_agent_heuristics(heuristic_alpha_beta_isoKnight.alphabeta_max_h, heuristics.base_heuristic,
                                       depth_player_1)
...
def play_with_advanced_heuristics():
    ...
    player_1 = player_agent_heuristics(heuristic_alpha_beta_isoKnight.alphabeta_max_h, heuristics.advanced_heuristic,
                                       depth_player_1)
    player_2 = player_agent_heuristics(heuristic_alpha_beta_isoKnight.alphabeta_min_h, heuristics.base_heuristic,
                                       depth_player_2)
